...
// Definindo condicionais do seguidor de linha SEM MEIO

bool frente1 = e2 == LOW && e1 == LOW && d1 == LOW && d2 == LOW;
bool frente2 = e2 == HIGH && e1 == HIGH && d1 == HIGH && d2 == HIGH;

bool direita1 = e2 == LOW && e1 == LOW && d1 == HIGH && d2 == HIGH;
bool direita2 = e2 == LOW && e1 == LOW && d1 == HIGH && d2 == LOW;

bool esquerda1 = e2 == HIGH && e1 == HIGH && d1 == LOW && d2 == LOW;
bool esquerda2 = e2 == LOW && e1 == HIGH && d1 == LOW && d2 == LOW;

void seguidorCarinhoso () { //  *Condicional do seguidor de linha*
  
  if (frente1) {            // 0 0 ? 0 0 -> siga frente
    forcamotor(180, 150);
  }

  else if (frente2) {       // 1 1 ? 1 1 -> siga frente
    forcamotor(180, 150);
  }

  else if (direita1) {      // 0 0 ? 1 1 -> virar direita
    forcamotor (-150, 180);
  }

  else if (direita2) {      // 0 0 ? 1 0 -> virar direita
    forcamotor (-150, 180);
    }
  else if (esquerda1) {     // 1 1 ? 0 0 -> virar esquerda
    forcamotor (180, -150);
    
  }
  else if (esquerda2) {     // 0 1 ? 0 0 -> virar esquerda
    forcamotor (180, -150);
